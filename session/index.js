 ...
 * @LastEditors: guoranzi 3406314102@qq.com
 * @LastEditTime: 2025-11-10 11:38:47
...
export function saveOrPublish(data) {
  ...
  return http.post(`/adminapi/workflow/template/save`, data, { headers })
}
// 详情
export function getDetail(data) {
  ...
  return http.post(`/adminapi/workflow/template/info`, data, { headers })
}
// 工单详情
export function getWorkOrderDetail(data) {
  ...
  return http.post(`/adminapi/workflow/order/info`, data, { headers })
}